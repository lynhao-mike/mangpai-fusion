...
- [ ] V5 `PictureFindings.industry_path: dict`（含 P_institutional / primary_path）
- [ ] V6 `wealth_level.framework: Literal["market_wealth", "power_hierarchy", "dual"]`
- [ ] V7 report-v1.4 模板 § 八·零 行业路径耦合提示
- [ ] V8 `tools/cross_domain_consistency_check.py --backfill` 历史报告回溯扫描
- [ ] 03-findings-schema.md schema_version 1.2.0 → 1.4.0（V5/V6 一并落，避免 schema 改两次）
