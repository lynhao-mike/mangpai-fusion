...
## 2026-06-02 · 地支三合伪组合纠错（C-2026-011）

### 纠错（invalid theory → corrected）
- `FIX-TRIAD-2026-0602-01` · 纠正“寅亥未三合木局”伪三合表述 · 影响文件：`cases/C-2026-011-乾-乙丑乙酉丁丑癸卯/career-projection.md`
  - 错误原因：将“寅亥六合”与“未”拼接成伪三合；标准三合木局只有“亥卯未”，寅未不成三合。
  - 核验依据：`theory/raw/gao/promoted/module-a-paipan.md` A.1.4 地支关系标准核验表；`sources/ren/MinerU_markdown_03、任付红-《民间实用八字初级班》_2056027147429675008.md` 第 661-673 行三合局原文。
  - 修正结果：保留“寅月为早春启动窗口”的判断，但依据改为“寅木生火并与原局时支卯木同气”，不再作为三合木局论证。
  - 影响核查：全文检索 `cases/`、`reports/`、`predictions/` 后，未发现其他“寅亥未三合木局 / 寅亥未.*三合 / 寅亥未.*木局”残留；C-2026-001 相关文件仅有“寅亥合解寅申冲”等合法六合用法，未发现该伪三合扩散。
