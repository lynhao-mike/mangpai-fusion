...
| D2 | 唯一标准报告 | 固化 C-2026-025 命主可读版结构；所有历史报告分支均作废，不得作为新案入口 | ✅ 已上线 |
...
├── render_report.py         ← C-2026-025 唯一标准报告渲染器（命主可读版；D1+D2）
...
| 项 | 处理 |
|---|---|
| 报告模板 | `templates/report-v1.3.md` 固化为 C-2026-025 唯一标准命主可读版；不再按 master/client 分支输出 |
