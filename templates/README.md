...
| [report-v1.3.md](report-v1.3.md) | 《命理师内容报告（统一版）》渲染入口基线；分析八字默认生成单份统一报告并归档，用户报告需明确命令；主要事项必须逐项输出 15 层判断 | 当前稳定标准 |
| [report-v5.md](report-v5.md) | 五派命理推理操作系统 v5 报告模板；适配子平类 / 滴天髓类 / 高德臣 / 段建业 / 杨清娟、三段式仲裁、受限概率、性格行为单列，并引用 outcome taxonomy 输出学业 / 事业 / 财富 / 婚姻 / 健康可回测等级映射 | v5 并行核心模板 |
