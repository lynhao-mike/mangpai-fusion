...
def build_v6_display_context(
    ...
    out.update({
        ...
        "性格置信度": ctx.get("personality_15tier_confidence", "待引擎补全"),
        ...
        "学业置信度": ctx.get("education_15tier_confidence", ctx.get("education_confidence_state", "待引擎补全")),
        ...
        "事业置信度": ctx.get("career_15tier_confidence", ctx.get("career_confidence_state", "待引擎补全")),
        ...
        "财富置信度": ctx.get("wealth_15tier_confidence", ctx.get("wealth_confidence_state", "待引擎补全")),
        ...
        "婚姻置信度": ctx.get("marriage_15tier_confidence", ctx.get("marriage_confidence_state", "待引擎补全")),
        ...
        "健康置信度": ctx.get("health_15tier_confidence", ctx.get("health_confidence_state", "待引擎补全")),
        ...
        "概率事件一置信状态": ctx.get("probability_event_1_confidence_state", "待反馈校准"),
        ...
        "概率事件二置信状态": ctx.get("probability_event_2_confidence_state", "待反馈校准"),
        ...
        "概率事件三置信状态": ctx.get("probability_event_3_confidence_state", "待反馈校准"),
        "概率事件三星级": ctx.get("probability_event_3_star", "待反馈校准"),
        "反馈一领域": ctx.get("probability_event_1_domain", "事业"),
        "反馈一窗口": ctx.get("probability_event_1_window", "待反馈校准"),
        "反馈一应事": ctx.get("probability_event_1_explanation", "待反馈校准"),
        "反馈一要点": "职位、平台、职责、行业或工作模式是否明显变化",
        "反馈二领域": ctx.get("probability_event_2_domain", "财富"),
        "反馈二窗口": ctx.get("probability_event_2_window", "待反馈校准"),
        "反馈二应事": ctx.get("probability_event_2_explanation", "待反馈校准"),
        "反馈二要点": "收入结构、资产配置、现金流或负债是否变化",
        "反馈三领域": ctx.get("probability_event_3_domain", "婚姻"),
        "反馈三窗口": ctx.get("probability_event_3_window", "待反馈校准"),
        "反馈三应事": ctx.get("probability_event_3_explanation", "待反馈校准"),
        "反馈三要点": "恋爱、婚姻、分合、家庭结构或关系压力是否出现",
